...
public:
	...
	*/
	...
	/*
	USAGE: Rotates the camera along the camera's right axis
	ARGUMENTS: float a_fAngle = 0.1f -> amount of movement
	OUTPUT: ---
	*/
	void RotateAroundXAxis(float a_fAngle = 0.1f);
	/*
	USAGE: Rotates the camera along the camera's up axis
	ARGUMENTS: float a_fAngle = 0.1f -> amount of movement
	OUTPUT: ---
	*/
	void RotateAroundYAxis(float a_fAngle = 0.1f);
